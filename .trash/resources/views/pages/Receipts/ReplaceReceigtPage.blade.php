...
<div class="page-body">
    <div class="container-xl">
        <div class="row row-cards">
            ...
            <div class="col-12">
                <form
                    action="/receipt/replace"
                    method="post"
                    class="card"
                >
                    @csrf
                    <div class="card-header">
                        <h4 class="card-title">Thay thế biên lai</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xl-2">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        value="{{$dataArrayResponse['Content']['Products']['Product']['ProdPrice']}}"
                                        id="receipt-cost"
                                        name="fee_cost"
                                    />
                                    <input
                            ...
                            <div class="col-md-3 col-xl-3">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        placeholder="0 VND"
                                        value="{{$dataArrayResponse['Content']['Products']['Product']['ProdPrice']*$dataArrayResponse['Content']['Products']['Product']['ProdQuantity']}} VND"
                                        disabled
                                    />
                                </div>
                            </div>
